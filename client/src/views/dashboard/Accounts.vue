		...
		<v-row>
			<v-col cols="12" sm="6" md="4" lg="3" v-for="acc in creditAccounts" :key="acc._id">
				<v-card>
					...
					<v-card-text>
						<p>
							Saldo <span class="font-weight-black float-right">{{ acc.startingBalance | formatCurrency }}</span>
						</p>
						<p>
							Instituição <span class="font-weight-black float-right">{{ acc.institution }}</span>
						</p>
